function [x_k, f_val, iter, status, computing_time] = DFP(x0, Obj, options)
    ...
    while grad_norm > tol && iter < max_iter && computing_time < 600
        ...
        alpha_k = armijo_backtracking(x_k, Obj.func(x_k), Obj.grad(x_k), p_k, alpha_init, Obj.func, options);  % Compute step size
