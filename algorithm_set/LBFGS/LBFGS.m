function [x_k, f_val, k, status, computing_time] = LBFGS(x0, Obj, options)
    ...
    while k < max_iter
        ...
        alpha_k = armijo_backtracking(x_k, f(x_k), grad_f(x_k), p_k, alpha_init, f, options);  % Compute step size
